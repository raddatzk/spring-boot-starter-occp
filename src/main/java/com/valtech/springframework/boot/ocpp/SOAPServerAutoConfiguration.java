...
@Configuration
@ConditionalOnExpression("${spring.ocpp.server.enabled:true} && '${spring.ocpp.server.type}'.equals('soap')")
@EnableConfigurationProperties({ServerProperties.class})
@Import({ServerProfilesConfig.class, ServerSSLConfig.class})
public class SOAPServerAutoConfiguration {
